  ...
  render() {
    ...
    let component = (
      ...
      <span className="file-custom"></span>
        <form ref="form" action={uploadUrl} method="POST"
            encType="multipart/form-data"
            target={this.frameId}
            style={{
              position: 'absolute', left: 0, top: 0, right: 0, bottom: 0, opacity:0
            }}>
            <input type="file" name="file" onChange={this._onUpload.bind(this)}
    ...
    return (
      <div>
        {component}
        <iframe ref="frame" id={this.frameId} name={this.frameId} style={{width:0, height:0, border: 'none'}} />
      </div>
    )
  }
}
